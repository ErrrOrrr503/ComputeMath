...
class transfer_equation {
    ...
    public:
        ...
        void solve_explicit_left_triange ();
        void solve_explicit_right_triange ();
...
template <typename num_t>
void transfer_equation<num_t>::solve_explicit_left_triange ()
{
...
template <typename num_t>
void transfer_equation<num_t>::solve_explicit_right_triange ()
{
    if (_rank)
        return;
    _u = new num_t[_x_points * _t_points];
    for (size_t layer = 0; layer < _t_points; layer++) {
        if (layer == 0) {
